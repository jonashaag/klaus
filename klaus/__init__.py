...
def make_app(repos, site_name, use_smarthttp=False, htdigest_file=None,
             ...
             unauthenticated_push=False, klaus_class=Klaus, **kwargs):
    """
    ...
    :param klaus_class: Use a custom subclass to construct the Klaus instance.
        If not given, defaults to `klaus.Klaus`
    :param kwargs: any extra kwargs are passed directly to the `klaus_class`
    constructor.
    """
